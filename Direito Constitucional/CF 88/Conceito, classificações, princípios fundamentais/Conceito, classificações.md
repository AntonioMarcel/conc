...
## 2. Concepção da Força Normativa
- **Autor:** Konrad Hesse  
...
- **Autor:** Hans Kelsen  
- **Ideia central:** A Constituição é uma **norma pura** (dever-ser) e suprema, fundamento de validade de todo o ordenamento (não possui pretensões sociológicas, políticas ou filosóficas, como traziam os outros autores).  
- **Contribuição:** hierarquia constitucional por meio da **Pirâmide de Kelsen** e princípio da **Supremacia da Constituição**.
- **Duas acepções:**
...
- **Cesaristas:** plebiscito ou referendo controlado pelo governante.  
  *Ex.: Napoleão (1800).*  
...
> - A regra será materialmente constitucional quando o conteúdo dela tratar de matéria essencial à Constituição (organização do Estado, separação de poderes, direitos fundamentais etc.),independentemente de estar ou não dentro do texto da CF.

## 10. Quanto à extensão
- **Sintéticas:** sumárias ou curtas. *Ex.: EUA/1787.*  
...
## Resumo da CF/88
PEDRA FORMAL: P: Promulgada, E: Escrita, D: Dogmática, R: Rígida, A: Analítica, F: Formal.
